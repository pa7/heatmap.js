/*
 * heatmap.js 0.2 Leaflet v0.8-dev overlay
 *
 ...
 *
 * Attribution
 *  - createTile fix based on https://github.com/pa7/heatmap.js/issues/86
 ...
 */
 ...
 L.GridLayer.HeatMap = L.GridLayer.extend({
    ...
    initialize: function (options, data) {
        ...
        this.on("tileload",function(data){
            self.drawTile(data.tile, data.tile._coords, self._map._zoom);
        });
    },
...
L.GridLayer.heatMap = function (options) {
    return new L.GridLayer.HeatMap(options);
};